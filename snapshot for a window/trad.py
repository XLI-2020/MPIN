...
from load_dataset import load_ICU_dataset, load_airquality_dataset, load_WiFi_dataset
...
if args.prefix == 'testNumStream':
    avg_df.to_csv(f'./exp_results/{args.method}_{args.prefix}_{args.dataset}_{args.k}_incre_{args.incre_mode}_window_{args.window}_eval_{args.eval_ratio}_stream_{args.stream}.csv', header=True, index=False)
else:
    avg_df.to_csv(f'./exp_results/{args.method}_{args.prefix}_{args.dataset}_{args.k}_incre_{args.incre_mode}_window_{args.window}_eval_{args.eval_ratio}.csv', header=True, index=False)
print('done!')

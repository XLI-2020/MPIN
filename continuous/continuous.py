...
from load_dataset import load_ICU_dataset_all, load_airquality_dataset_all, load_WiFi_dataset_all, get_model_size
...
if args.dataset in ["KDM", "WDS", "LHS"]:
    base_X = load_WiFi_dataset_all(dataset_name=args.dataset, time_step=5, method='mpin')
...
def window_imputation(start, end, sample_ratio, initial_state_dict=None, X_last=None, mask_last=None, mae_last=None, transfer=False, state=args.state):
    ...
    return best_state_dict, keep_X.tolist(), keep_mask, results_list, min_mae_error
